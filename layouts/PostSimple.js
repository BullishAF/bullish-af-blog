  ...
  return (
    <SectionContainer>
      ...
      <article>
        <div>
          <header>
            <div className="space-y-1 border-b border-gray-700 pb-10 text-center dark:border-gray-200">
              <dl>
                <div>
          ...
          <div
            className="divide-y divide-gray-700 pb-8 dark:divide-gray-200 xl:divide-y-0 "
